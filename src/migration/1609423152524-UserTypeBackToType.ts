...
export class UserTypeBackToType1609423152524 implements MigrationInterface {
    name = 'UserTypeBackToType1609423152524'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gig_user_type" ADD CONSTRAINT "UQ_a6457c3dce6eae4a401bd77ac0c" UNIQUE ("userId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "gig"."price" IS NULL`);
        await queryRunner.query(`ALTER TABLE "gig" ALTER COLUMN "price" TYPE numeric`);
        await queryRunner.query(`ALTER TABLE "gig_user_type" DROP CONSTRAINT "UQ_a6457c3dce6eae4a401bd77ac0c"`);
